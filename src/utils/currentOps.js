...
// One row per in-progress operation: the handful of fields this module filters and
// retains by, plus `raw` — the document exactly as the server sent it, which is what the
// views render. Nothing is dropped on the way through.
